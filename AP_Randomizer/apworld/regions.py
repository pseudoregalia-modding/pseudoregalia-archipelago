...
region_table: Dict[str, List[str]] = {
    ...
    "Dungeon Strong Eyes": ["Castle Sansa"],
    "Castle Sansa": ["Library Main", "Keep Main", "Empty Bailey", "Theatre Pillar", "Theatre Main",],
    "Library Main": ["Library Locked",],
    "Library Locked": [],
    "Keep Main": ["Keep Sunsetter", "Underbelly Hole", "Theatre Main",],
    "Keep Sunsetter": [],
    "Empty Bailey": ["Castle Sansa", "Tower Remains", "Theatre Pillar",],
